...
\item If Timmy sells less lemonade in week $x$ than in week $y$ where $x<y$, and Timmy's sales has increased every week, what relationship describes $y$ to $x$?
...
\1 The probability of choosing a prime number out of $x$ terms is $m$ and the odds of choosing and even number out of the same $x$ terms is $n$. What are the odds of choosing an even prime out of $x^2$ terms?
